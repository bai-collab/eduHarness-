...
## v2026.08.1（2026-08-10）

修正 v2026.08.0 的技能一覽（`docs/reference/skills.md`）遺漏本次新增的 4 個技能——臆測五階段、教育 Web 教學遊戲工作流、闖關遊戲 Three.js 導入、受眾成果校準。技能檔本身在 v2026.08.0 已正確發佈，只是索引頁未同步刷新。

- 技能一覽補齊 4 個新技能與其一句話用途。
- 索引頁改為「每次發佈前自動重新生成」，新技能一進白名單就會出現在索引，不再靠人工同步。
