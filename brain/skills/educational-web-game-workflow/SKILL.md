...
- AetherForge 免費素材（外部候選來源，僅在使用者明確核准且本機可用時查閱；local-only Harness 不自動下載）：2D sprite，粉彩／點陣風格；角色、生活道具、事件物品、消耗品與合成素材。每件素材仍須逐件記錄實際授權文字／條款、取得日期、來源 URL、版本與 SHA-256。
